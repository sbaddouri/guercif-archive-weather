...
const YEAR = 2007;
const EXPECTED_DAYS = 365; // 2007 est une année standard (non bissextile, 28 jours en février)

const DATA_DIR = path.join(process.cwd(), 'data');

async function fetchAndSaveYear2007() {
...
fetchAndSaveYear2007().catch(err => {
