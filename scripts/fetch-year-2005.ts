...
const YEAR = 2005;
const EXPECTED_DAYS = 365; // 2005 est une année standard (non bissextile, 28 jours en février)

const DATA_DIR = path.join(process.cwd(), 'data');

async function fetchAndSaveYear2005() {
...
fetchAndSaveYear2005().catch(err => {
