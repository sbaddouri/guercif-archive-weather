...
const YEAR = 2009;
const EXPECTED_DAYS = 365; // 2009 est une année standard (non bissextile, 28 jours en février)

const DATA_DIR = path.join(process.cwd(), 'data');

async function fetchAndSaveYear2009() {
...
fetchAndSaveYear2009().catch(err => {
