...
async function fetchAndSaveYear2013() {
  console.log(`[INFO] Récupération de l'année ${YEAR} depuis Open-Meteo...`);
  ...
  console.log(`[SUCCESS] Année ${YEAR} complétée : ${savedDaily} fichiers journaliers et ${savedHourly} fichiers horaires enregistrés.`);
}

fetchAndSaveYear2013().catch(err => {
