...
const YEAR = 2003;
const EXPECTED_DAYS = 365; // 2003 est une année standard (non bissextile, 28 jours en février)

const DATA_DIR = path.join(process.cwd(), 'data');

async function fetchAndSaveYear2003() {
...
fetchAndSaveYear2003().catch(err => {
