...
const YEAR = 2010;
const EXPECTED_DAYS = 365; // 2010 est une année standard (non bissextile, 28 jours en février)

const DATA_DIR = path.join(process.cwd(), 'data');

async function fetchAndSaveYear2010() {
...
fetchAndSaveYear2010().catch(err => {
